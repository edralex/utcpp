...
TEMPLATE_TEST_CASE("mutable_fws_multimap_test, int_1", "",
                   strong_key<unsigned>, weak_key<unsigned>) {
  using KeyType = TestType;
  mutable_fws_multimap<KeyType, int> mm;
...
TEMPLATE_TEST_CASE("mutable_fws_multimap_test, int_insert_1", "",
                   strong_key<unsigned>, weak_key<unsigned>) {
  using KeyType = TestType;
...
TEMPLATE_TEST_CASE("mutable_fws_multimap_test, int_erase_1", "",
