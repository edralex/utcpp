...
TEST_CASE("nvec test", "[containers]") {
  ...
  CHECK(2U == v.size(0U));
  CHECK(3U == v.size(1U));
  CHECK(2U == v.size(0U, 0U));
  CHECK(3U == v.size(0U, 1U));
  CHECK(2U == v.size(1U, 0U));
  CHECK(3U == v.size(1U, 1U));
  CHECK(1U == v.size(1U, 2U));
  CHECK(2U == v.size(2U, 0U));
  CHECK(3U == v.size(2U, 1U));
  CHECK(1U == v.size(2U, 2U));

  CHECK(2U == v[0U].size());
  CHECK(3U == v[1U].size());
  CHECK(2U == v[0U][0U].size());
  CHECK(3U == v[0U][1U].size());
  CHECK(2U == v[1U][0U].size());
  CHECK(3U == v[1U][1U].size());
  CHECK(1U == v[1U][2U].size());
  CHECK(2U == v[2U][0U].size());
  CHECK(3U == v[2U][1U].size());
  CHECK(1U == v[2U][2U].size());
}