...
TEST(OffsetStaticVersionTest, SerializeFile) {
...
TEST(OffsetStaticVersionTest, SerializeBuf) {
  constexpr auto const MODE =
      cista::mode::WITH_INTEGRITY | cista::mode::WITH_STATIC_VERSION;
...
TEST(OffsetStaticVersionTest, SerializeMmapFile) {
...
TEST(OffsetStaticVersionTest, SerializeEndianTest) {
